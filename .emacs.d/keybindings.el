...
;; Flycheck
(progn
  (define-key flycheck-mode-map (kbd "C-f C-f") (lambda ()
                                                  (interactive)
                                                  (flycheck-list-errors)
                                                  (pop-to-buffer (get-buffer "*Flycheck errors*"))
                                                  ))
  (define-key flycheck-mode-map (kbd "C-f C-n") (lambda ()
                                                  (interactive)
                                                  (flycheck-next-error)
                                                  (reposition-window)
                                                  ))
  (define-key flycheck-mode-map (kbd "C-f C-p") (lambda ()
                                                  (interactive)
                                                  (flycheck-previous-error)
                                                  (reposition-window)
                                                  ))
  (define-key flycheck-error-list-mode-map (kbd "RET") (lambda ()
                                                         (interactive)
                                                         (flycheck-error-list-goto-error)
                                                         (let ((b (get-buffer "*Flycheck errors*")))
                                                           (if b (kill-buffer b))
                                                           )
                                                         (reposition-window)
                                                         ))
